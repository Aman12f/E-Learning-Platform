...
with open("E:/Documents/IIIt_Nagpur/FINAL-YEAR-PROJECT/mern/Mern-Elearning-main/server/mlModel/vectorizer_fited.pkl", 'rb') as file:
    loaded_vectorizer = pickle.load(file)

with open("E:/Documents/IIIt_Nagpur/FINAL-YEAR-PROJECT/mern/Mern-Elearning-main/server/mlModel/description_fit_transformed.pkl", 'rb') as file:
    loaded_description = pickle.load(file)

with open("E:/Documents/IIIt_Nagpur/FINAL-YEAR-PROJECT/mern/Mern-Elearning-main/server/mlModel/index_course_name.json", 'r') as file:
    loaded_dictionary = json.load(file)
